...
export const getExpensesLocally = async () => {
  try {
...
export const removePendingExpense = async (pendingId) => {
  try {
    const pending = await getPendingExpenses();
...
export const addDeletedExpense = async (expenseId) => {
  try {
...
export const removeDeletedExpense = async (expenseId) => {
  try {
    const deleted = await getDeletedExpenses();
